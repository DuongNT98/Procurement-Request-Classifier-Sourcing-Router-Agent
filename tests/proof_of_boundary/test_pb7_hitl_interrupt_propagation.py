...
#
# References:
#   Proof-of-Boundary PB-7 (HITL interrupt propagation)
#   Framework HITL compliance rules (D6 pattern, hitl_allowed guard)
#   conditional PB-7 scaffold stub — hitl_allowed guard
...
def test_pb7_hitl_allowed_false_skips_interrupt() -> None:
    ...
    Covers the framework's HITL compliance rule for the hitl_allowed guard:
